...
<body>
            ...
            <a class="navbar-brand" href="#index.html">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ms-lg-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="data.html">Data Projek</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="tambah_projek.php">Tambah Projek<span class="sr-only">(current)</span></a>
                        </li>
 ...
 <section class="w3l-contacts-12" id="tambah">
        <div class="contact-top pt-5">
            <div class="container py-lg-5 py-2">
                <div class="title-heading-w3 mx-auto text-center mb-sm-5 mb-4">
                    <h3 class="w3l-title-main">Halaman Tambah Projects</h3>
                </div>
                <div class="d-grid cont-main-top">
                    <!-- contact form -->
                    <div class="contacts12-main">
                        <form action="proses_tambahprojek.php" method="post" class="main-input">
                            <div class="top-inputs d-grid">
                            </div>
                            <input type="text" placeholder="Name Project" name="nama" id="w3lName" required>
                            <textarea placeholder="Deskripsi Project" name="deskripsi" id="w3lSender" required></textarea>
                            <input type="text" placeholder="Harga Bid" name="harga" id="w3lName" required>
                            <input type="text" placeholder="Deadline" name="deadline" id="w3lMessage" required>
                            <div class="text-end">
